                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Administrador de usuarios') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('user.index') }}" class="btn btn-sm btn-primary">{{ __('Volver a usuarios') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('role') ? ' has-danger' : '' }}">
                                   <div class="form-group">
                                       ...
                                       <select class="custom-select" name="role" id="role_select">
                        ...
                        <form method="post" action="{{ route('user.password', $user->id) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="password" name="password" id="input-password" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('Nueva Contraseña') }}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control form-control-alternative" placeholder="{{ __('Confirmar Nueva Contraseña') }}" >
                                </div>
